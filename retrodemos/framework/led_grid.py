...
see PLAN.md's "LED grid module" section): the seven-segment digit renderer
(`SevenSegmentDisplay`, LED's), the dot-matrix renderer (`DotMatrixDisplay`,
LED II's), and the bit-column renderer (`BitColumnDisplay`, Title's).
...
around a shape it doesn't describe.
"""
